  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 outline outline-1 outline-border transition-all duration-300 ${
          scrolled
            ? "bg-dark/90 backdrop-blur-xl shadow-lg shadow-black/10"
            : "bg-transparent"
        }`}
      >
